...
// Updated 2026-01-19: ICAO Merkle root from mobile app's proof (includes German CSCA)
// This root is computed by processing the Merkle proof the app sends with the German CSCA leaf
